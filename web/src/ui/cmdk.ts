...
const ALL_CMDS: Cmd[] = [
  ...
  { group: "MODEL",    icon: "explode",  label: "explode — Explode polysurface into individual faces",   kbd: "", run: () => dispatchSync("setActiveTool", { toolId: "explode" }) },
  { group: "MODEL",    icon: "join",     label: "join — Join surfaces into one polysurface",              kbd: "", run: () => dispatchSync("setActiveTool", { toolId: "join" }) },
  { group: "MODEL",    icon: "rebuild",  label: "rebuild — Rebuild NURBS surface with new point count",  kbd: "", run: () => dispatchSync("setActiveTool", { toolId: "rebuild" }) },
  { group: "MODEL",    icon: "contour",  label: "contour — Slice solid with planes → contour curves",    kbd: "", run: () => dispatchSync("setActiveTool", { toolId: "contour" }) },
