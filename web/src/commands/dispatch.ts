...
//   3. runtime alias-json from ~/.web-cad/aliases.json (deep-merge
 ...
 * boot (best-effort fetch of ~/.web-cad/aliases.json) and
...
/**
 * Best-effort runtime fetch of ~/.web-cad/aliases.json.
